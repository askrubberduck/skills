<!-- translation-source: README.md sha256=b6c9b22e12e708fe7e300e5be81ae6024dc82064808f2f7889f261669ae75479 -->
...
Столько, сколько нужно, чтобы проверить утверждение. Лишние стулья за столом проверку
убедительнее не делают.
...
пропустили оба ревьюера? `scripts/ledger.py remaining` оценивает это по их общим
находкам. Какое семейство что лучше ловит? `precision`. Кто ревьюит следующим? `pick` выбирает по
