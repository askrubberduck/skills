...
Read the code each comment describes and apply [the prose bar](references/bar.md), including whether
tools consume the text. Fix generated prose at its source, or leave it when that generator is
outside scope.
