...
Git, use a source snapshot or equivalent identity. A moved cited boundary makes the record stale; an
unrelated HEAD change alone does not. Return the result to the caller without starting the next
stage.
