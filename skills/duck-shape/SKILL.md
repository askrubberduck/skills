...
The changed lines bound the edits, not the reading: a duplicate rule or a second owner of the same
state usually sits in a file the diff never touched. Read the affected path through its callers, state owners and observable effects. Inspect shared
