...
- Name the handoff when the scan reveals one: backlog full of stale/blocked rot → nuclear-cut; pickables ready and the user wants them executed → nuclear-campaign.
